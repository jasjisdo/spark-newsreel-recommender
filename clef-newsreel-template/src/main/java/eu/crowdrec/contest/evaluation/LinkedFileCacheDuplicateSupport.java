...
public class LinkedFileCacheDuplicateSupport {
	 ...
	 * 
	 * @param _groundTruthFilename the name of the groundTruth file
	 * @return success
	 */
		...
		if (inLogFile.isFile()) {
			...
			File[] childs = inLogFile.listFiles(new FilenameFilter() {
				...
				public boolean accept(File dir, String name) {
					...
					return fileName.endsWith("data.idomaar.txt.gz") ||
                            fileName.endsWith("data.idomaar.txt") ||
                            fileName.startsWith("contest.log.") && fileName.endsWith(".gz") ||
                            fileName.startsWith("contest.log.") && fileName.endsWith(".txt");
				}
			});
	 ...
	 * @param duplicateCheckString the Key of the entry that is invalid
	 */
